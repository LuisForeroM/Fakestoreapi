...
function Principal() {
  ...
  const loadInitialData = async () => {
    ...
    try {
      ...
      const categoriesData = await storeService.getCategories(); // Aquí se llama a getCategories
        ...
        <nav class="navbar">
          ...
          <div className="top_bar">
            ...
            <div className="dropdown">
              <button className="dropbtn">Categoría  <FaChevronDown></FaChevronDown></button>
              <div className="dropdown-content">
                <button onClick={() => handleCategorySelect('')}>Todas las categorías</button>
